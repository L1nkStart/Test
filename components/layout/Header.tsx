...
export function Header() {
  ...
  return (
    <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 shadow-sm px-8 py-6">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Button
              variant="ghost"
              size="sm"
              className="w-9 h-9 p-2 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200"
